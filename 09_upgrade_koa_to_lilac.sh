...
# tutor local run lms sh -c "python manage.py lms migrate course_overviews 0023 --fake"
# tutor local run lms sh -c "python manage.py lms migrate course_overviews 0024 --fake"
