...
# 1. Export Maple DB
# -------------------------------
## Create export directory for Maple
EXPORT_DIR="maple_export"
...
# 2. Install Nutmeg and import Maple DB
# -------------------------------
...
echo -e "${BLUE}Installing Tutor v14.2.3 (Nutmeg)...${NC}"
...
## Import Maple DB
echo -e "${BLUE}Importing Maple DB...${NC}"
