...
# 2. Install Sumac and import Redwood DB
# -------------------------------
...
echo -e "${BLUE}Installing Tutor v19.0.1 (Sumac)...${NC}"
tutor local launch -I

echo -e "${BLUE}Tutor Sumac installation completed!${NC}"
...
## Import Redwood DB
echo -e "${BLUE}Importing Redwood DB...${NC}"
