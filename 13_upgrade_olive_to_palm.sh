...
# 1. Export Olive DB
# -------------------------------
## Create export directory for Olive
EXPORT_DIR="olive_export"
...
# 2. Install Palm and import Olive DB
# -------------------------------
...
echo -e "${BLUE}Installing Tutor v16.1.8 (Palm)...${NC}"
tutor local launch -I

echo -e "${BLUE}Tutor Palm installation completed!${NC}"
...
## Import Olive DB
echo -e "${BLUE}Importing Olive DB...${NC}"
